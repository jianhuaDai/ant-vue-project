<template>
  <div class="duty-statis">
    <div class="duty-statis-cont">
      ...
      <!-- 事件查询详情 -->
      <a-modal title="事件查询详情" :visible="visible" width="45%" @cancel="handleCancel" footer>
        <a-form :form="form2">
          <a-row :gutter="8">
            <a-col :span="24">
              <h4>基本信息</h4>
...
export default {
  ...
  methods: {
    ...
    searchData(reqData) {
      this.dataLoad = true
      getEventQuery(reqData)
        .then(res => {
          console.log('===getEventQuery success ====')
          this.dataLoad = false

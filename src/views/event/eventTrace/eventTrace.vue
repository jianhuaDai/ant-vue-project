<template>
  <div class="duty-statis">
    <div class="duty-statis-cont">
      ...
      <!-- 事件跟踪详情 -->
      <a-modal title="事件跟踪详情" :visible="visible" width="45%" @cancel="handleCancel" footer>
        <a-form :form="form2">
          <a-row :gutter="8">
            <a-col :span="24">
              <h4>基本信息</h4>
...
<script>
import { getEventTrace } from '@/api/event';
...
export default {
  data() {
    return {
      ...
      listHeight: window.innerHeight - 125,
  ...
  methods: {
    ...
    searchData(reqData) {
      this.dataLoad = true
      getEventTrace(reqData)
        .then(res => {
          console.log('===getEventTrace success ====')
          this.dataLoad = false
